...
public class EnemyController {
    ...
    private void cargarObjetosN() {
        ...
        EnemyActor e6 = new EnemyActor(texture, new Vector2(580,height), size, 2, timeL, posNave, cimg);
        ...
        EnemyActor e13 = new EnemyActor(texture, new Vector2(580,height - size.y - 10), size, 2, timeL, posNave, cimg);
